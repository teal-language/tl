...
for i, name in ipairs({"records", "arrayrecords", "interfaces", "arrayinterfaces"}) do
   ...
   describe("#" .. name, function()
      ...
      it("creation of userdata records should be disallowed (#460)", util.check_type_error([[
         ...
         select(i,
            { y = 6, msg = "in assignment: userdata "..statement.." doesn't match: "..statement.." (a: number)" },
            { y = 6, msg = "in assignment: userdata "..statement.." doesn't match: "..statement.." ({number}a: number)" },
            { y = 6, msg = "in assignment: got record (a: integer), expected Foo" },
            { y = 6, msg = "in assignment: got record (a: integer), expected Foo" }
         ),
         { y = 8, msg = "argument 1: got {}, expected Foo" },
         select(i,
            { y = 9, msg = "argument 1: userdata "..statement.." doesn't match: "..statement.." (a: number)" },
            { y = 9, msg = "argument 1: userdata "..statement.." doesn't match: "..statement.." ({number}a: number)" },
