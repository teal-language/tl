   ...
   local standard_library = {
      ...
      ["collectgarbage"] = a_type({
         ...
         types = {
            ...
            a_type({ typename = "function", args = TUPLE({ an_enum({ "step", "setpause", "setstepmul" }), INTEGER }), rets = TUPLE({ NUMBER }) }),
      ...
      ["error"] = a_type({ typename = "function", args = TUPLE({ ANY, INTEGER }), rets = TUPLE({}) }),
   ...
   a_type({ typename = "function", args = TUPLE({}), rets = TUPLE({ a, b }) }),
      ...
      ["tonumber"] = a_type({
         ...
         types = {
            ...
            a_type({ typename = "function", args = TUPLE({ ANY, INTEGER }), rets = TUPLE({ INTEGER }) }),
         },
      }),
      ...
      ["debug"] = a_type({
         ...
         fields = {
            ...
            ["getlocal"] = a_type({
               typename = "poly",
               types = {
                  a_type({ typename = "function", args = TUPLE({ THREAD, FUNCTION, INTEGER }), rets = STRING }),
                  a_type({ typename = "function", args = TUPLE({ THREAD, INTEGER, INTEGER }), rets = TUPLE({ STRING, ANY }) }),
                  a_type({ typename = "function", args = TUPLE({ FUNCTION, INTEGER }), rets = STRING }),
                  a_type({ typename = "function", args = TUPLE({ INTEGER, INTEGER }), rets = TUPLE({ STRING, ANY }) }),
               },
            }),
            ["getmetatable"] = a_gfunction(1, function(a) return { args = TUPLE({ a }), rets = TUPLE({ METATABLE(a) }) } end),
            ["getregistry"] = a_type({ typename = "function", args = TUPLE({}), rets = TUPLE({ TABLE }) }),
            ["getupvalue"] = a_type({ typename = "function", args = TUPLE({ FUNCTION, INTEGER }), rets = TUPLE({ ANY }) }),
            ["getuservalue"] = a_type({ typename = "function", args = TUPLE({ USERDATA, INTEGER }), rets = TUPLE({ ANY }) }),
            ["sethook"] = a_type({
               typename = "poly",
               types = {
                  a_type({ typename = "function", args = TUPLE({ THREAD, DEBUG_HOOK_FUNCTION, STRING, INTEGER }), rets = TUPLE({}) }),
                  a_type({ typename = "function", args = TUPLE({ DEBUG_HOOK_FUNCTION, STRING, INTEGER }), rets = TUPLE({}) }),
               },
            }),
            ["setlocal"] = a_type({
               typename = "poly",
               types = {
                  a_type({ typename = "function", args = TUPLE({ THREAD, INTEGER, INTEGER, ANY }), rets = TUPLE({ STRING }) }),
                  a_type({ typename = "function", args = TUPLE({ INTEGER, INTEGER, ANY }), rets = TUPLE({ STRING }) }),
               },
            }),
            ["setmetatable"] = a_gfunction(1, function(a) return { args = TUPLE({ a, METATABLE(a) }), rets = TUPLE({ a }) } end),
            ["setupvalue"] = a_type({ typename = "function", args = TUPLE({ FUNCTION, INTEGER, ANY }), rets = TUPLE({ STRING }) }),
            ["setuservalue"] = a_type({ typename = "function", args = TUPLE({ USERDATA, ANY, INTEGER }), rets = TUPLE({ USERDATA }) }),
            ["traceback"] = a_type({
               typename = "poly",
               types = {
                  a_type({ typename = "function", args = TUPLE({ THREAD, STRING, INTEGER }), rets = TUPLE({ STRING }) }),
                  a_type({ typename = "function", args = TUPLE({ STRING, INTEGER }), rets = TUPLE({ STRING }) }),
               },
            }),
            ["upvalueid"] = a_type({ typename = "function", args = TUPLE({ FUNCTION, INTEGER }), rets = TUPLE({ USERDATA }) }),
            ["upvaluejoin"] = a_type({ typename = "function", args = TUPLE({ FUNCTION, INTEGER, FUNCTION, INTEGER }), rets = TUPLE({}) }),
            ["getinfo"] = a_type({
               typename = "poly",
               types = {
      ...
      ["math"] = a_type({
         ...
         fields = {
            ...
            ["randomseed"] = a_type({ typename = "function", args = TUPLE({ INTEGER, INTEGER }), rets = TUPLE({ INTEGER, INTEGER }) }),
         ...
         fields = {
            ...
            ["date"] = a_type({
               ...
               types = {
                  ...
                  a_type({ typename = "function", args = TUPLE({ an_enum({ "!*t", "*t" }), INTEGER }), rets = TUPLE({ OS_DATE_TABLE }) }),
                  a_type({ typename = "function", args = TUPLE({ OPT(STRING), OPT(INTEGER) }), rets = TUPLE({ STRING }) }),
               },
            }),
            ["difftime"] = a_type({ typename = "function", args = TUPLE({ INTEGER, INTEGER }), rets = TUPLE({ INTEGER }) }),
            ["execute"] = a_type({ typename = "function", args = TUPLE({ STRING }), rets = TUPLE({ BOOLEAN, STRING, INTEGER }) }),
            ["exit"] = a_type({ typename = "function", args = TUPLE({ UNION({ INTEGER, BOOLEAN }), BOOLEAN }), rets = TUPLE({}) }),
      ...
      ["string"] = a_type({
         ...
         fields = {
            ["byte"] = a_type({
               typename = "poly",
               types = {
                  a_type({ typename = "function", args = TUPLE({ STRING, OPT(INTEGER) }), rets = TUPLE({ INTEGER }) }),
                  a_type({ typename = "function", args = TUPLE({ STRING, INTEGER, INTEGER }), rets = VARARG({ INTEGER }) }),
               },
            }),
            ["char"] = a_type({ typename = "function", args = VARARG({ INTEGER }), rets = TUPLE({ STRING }) }),
            ["dump"] = a_type({ typename = "function", args = TUPLE({ FUNCTION, OPT(BOOLEAN) }), rets = TUPLE({ STRING }) }),
            ["find"] = a_type({ typename = "function", args = TUPLE({ STRING, STRING, OPT(INTEGER), OPT(BOOLEAN) }), rets = VARARG({ INTEGER, INTEGER, STRING }) }),
            ...
            ["gsub"] = a_type({
               typename = "poly",
               types = {
                  a_type({ typename = "function", args = TUPLE({ STRING, STRING, STRING, INTEGER }), rets = TUPLE({ STRING, INTEGER }) }),
                  a_type({ typename = "function", args = TUPLE({ STRING, STRING, a_type({ typename = "map", keys = STRING, values = STRING }), INTEGER }), rets = TUPLE({ STRING, INTEGER }) }),
                  a_type({ typename = "function", args = TUPLE({ STRING, STRING, a_type({ typename = "function", args = VARARG({ STRING }), rets = TUPLE({ STRING }) }), INTEGER }), rets = TUPLE({ STRING, INTEGER }) }),
                  a_type({ typename = "function", args = TUPLE({ STRING, STRING, a_type({ typename = "function", args = VARARG({ STRING }), rets = TUPLE({ NUMBER }) }), INTEGER }), rets = TUPLE({ STRING, INTEGER }) }),
                  a_type({ typename = "function", args = TUPLE({ STRING, STRING, a_type({ typename = "function", args = VARARG({ STRING }), rets = TUPLE({ BOOLEAN }) }), INTEGER }), rets = TUPLE({ STRING, INTEGER }) }),
                  a_type({ typename = "function", args = TUPLE({ STRING, STRING, a_type({ typename = "function", args = VARARG({ STRING }), rets = TUPLE({}) }), INTEGER }), rets = TUPLE({ STRING, INTEGER }) }),
            ...
            ["match"] = a_type({ typename = "function", args = TUPLE({ STRING, STRING, INTEGER }), rets = VARARG({ STRING }) }),
            ...
            ["rep"] = a_type({ typename = "function", args = TUPLE({ STRING, INTEGER, OPT(STRING) }), rets = TUPLE({ STRING }) }),
            ["reverse"] = a_type({ typename = "function", args = TUPLE({ STRING }), rets = TUPLE({ STRING }) }),
            ["sub"] = a_type({ typename = "function", args = TUPLE({ STRING, INTEGER, INTEGER }), rets = TUPLE({ STRING }) }),
            ["unpack"] = a_type({ typename = "function", args = TUPLE({ STRING, STRING, OPT(INTEGER) }), rets = VARARG({ ANY }) }),
      ...
      ["table"] = a_type({
         typename = "record",
         fields = {
            ["concat"] = a_type({ typename = "function", args = TUPLE({ ARRAY(UNION({ STRING, NUMBER })), OPT(STRING), OPT(INTEGER), OPT(INTEGER) }), rets = TUPLE({ STRING }) }),
            ["insert"] = a_type({
               typename = "poly",
               types = {
                  a_gfunction(1, function(a) return { args = TUPLE({ ARRAY(a), INTEGER, a }), rets = TUPLE({}) } end),
            ...
            ["move"] = a_type({
               typename = "poly",
               types = {
                  a_gfunction(1, function(a) return { args = TUPLE({ ARRAY(a), INTEGER, INTEGER, INTEGER }), rets = TUPLE({ ARRAY(a) }) } end),
                  a_gfunction(1, function(a) return { args = TUPLE({ ARRAY(a), INTEGER, INTEGER, INTEGER, ARRAY(a) }), rets = TUPLE({ ARRAY(a) }) } end),
               },
            }),
            ["pack"] = a_type({ typename = "function", args = VARARG({ ANY }), rets = TUPLE({ TABLE }) }),
            ["remove"] = a_gfunction(1, function(a) return { args = TUPLE({ ARRAY(a), OPT(INTEGER) }), rets = TUPLE({ a }) } end),
            ["sort"] = a_gfunction(1, function(a) return { args = TUPLE({ ARRAY(a), OPT(TABLE_SORT_FUNCTION) }), rets = TUPLE({}) } end),
            ["unpack"] = a_gfunction(1, function(a) return { needs_compat = true, args = TUPLE({ ARRAY(a), INTEGER, INTEGER }), rets = VARARG({ a }) } end),
         },
      }),
      ["utf8"] = a_type({
         typename = "record",
         fields = {
            ["char"] = a_type({ typename = "function", args = VARARG({ INTEGER }), rets = TUPLE({ STRING }) }),
            ["charpattern"] = STRING,
            ["codepoint"] = a_type({ typename = "function", args = TUPLE({ STRING, OPT(INTEGER), OPT(INTEGER) }), rets = VARARG({ INTEGER }) }),
            ["codes"] = a_type({ typename = "function", args = TUPLE({ STRING }), rets = TUPLE({
               a_type({ typename = "function", args = TUPLE({ STRING, OPT(INTEGER) }), rets = TUPLE({ INTEGER, INTEGER }) }),
            }), }),
            ["len"] = a_type({ typename = "function", args = TUPLE({ STRING, INTEGER, INTEGER }), rets = TUPLE({ INTEGER }) }),
            ["offset"] = a_type({ typename = "function", args = TUPLE({ STRING, INTEGER, INTEGER }), rets = TUPLE({ INTEGER }) }),
         },
      }),
      ["_VERSION"] = STRING,
   }
