...
-- module teal.checker.checker from teal/checker/checker.lua
package.preload["teal.checker.checker"] = function(...)
local errors = require("teal.errors")
...
-- module teal.checker.context from teal/checker/context.lua
package.preload["teal.checker.context"] = function(...)
...
-- module teal.checker.file_checker from teal/checker/file_checker.lua
package.preload["teal.checker.file_checker"] = function(...)
local _tl_compat; if (tonumber((_VERSION or ''):match('[%d.]*$')) or 0) < 5.3 then local p, m = pcall(require, 'compat53.module'); if p then _tl_compat = m end end; local io = _tl_compat and _tl_compat.io or io; local string_checker = require("teal.checker.string_checker")
...
-- module teal.checker.node_checker from teal/checker/node_checker.lua
package.preload["teal.checker.node_checker"] = function(...)
local environment = require("teal.environment")
...
-- module teal.checker.relations from teal/checker/relations.lua
package.preload["teal.checker.relations"] = function(...)
local _tl_compat; if (tonumber((_VERSION or ''):match('[%d.]*$')) or 0) < 5.3 then local p, m = pcall(require, 'compat53.module'); if p then _tl_compat = m end end; local ipairs = _tl_compat and _tl_compat.ipairs or ipairs; local math = _tl_compat and _tl_compat.math or math; local pairs = _tl_compat and _tl_compat.pairs or pairs; local string = _tl_compat and _tl_compat.string or string; local table = _tl_compat and _tl_compat.table or table; local errors = require("teal.errors")
...
-- module teal.checker.require_file from teal/checker/require_file.lua
package.preload["teal.checker.require_file"] = function(...)
local _tl_compat; if (tonumber((_VERSION or ''):match('[%d.]*$')) or 0) < 5.3 then local p, m = pcall(require, 'compat53.module'); if p then _tl_compat = m end end; local assert = _tl_compat and _tl_compat.assert or assert; local io = _tl_compat and _tl_compat.io or io; local os = _tl_compat and _tl_compat.os or os; local package = _tl_compat and _tl_compat.package or package; local string = _tl_compat and _tl_compat.string or string; local table = _tl_compat and _tl_compat.table or table; local file_checker = require("teal.checker.file_checker")
...
-- module teal.checker.special_functions from teal/checker/special_functions.lua
package.preload["teal.checker.special_functions"] = function(...)
local _tl_compat; if (tonumber((_VERSION or ''):match('[%d.]*$')) or 0) < 5.3 then local p, m = pcall(require, 'compat53.module'); if p then _tl_compat = m end end; local assert = _tl_compat and _tl_compat.assert or assert; local string = _tl_compat and _tl_compat.string or string; local table = _tl_compat and _tl_compat.table or table; local node_checker = require("teal.checker.node_checker")
...
-- module teal.checker.string_checker from teal/checker/string_checker.lua
package.preload["teal.checker.string_checker"] = function(...)
local _tl_compat; if (tonumber((_VERSION or ''):match('[%d.]*$')) or 0) < 5.3 then local p, m = pcall(require, 'compat53.module'); if p then _tl_compat = m end end; local table = _tl_compat and _tl_compat.table or table; local visitors = require("teal.checker.visitors")
...
-- module teal.checker.type_checker from teal/checker/type_checker.lua
package.preload["teal.checker.type_checker"] = function(...)
local attributes = require("teal.attributes")
...
-- module teal.checker.visitors from teal/checker/visitors.lua
package.preload["teal.checker.visitors"] = function(...)
local _tl_compat; if (tonumber((_VERSION or ''):match('[%d.]*$')) or 0) < 5.3 then local p, m = pcall(require, 'compat53.module'); if p then _tl_compat = m end end; local assert = _tl_compat and _tl_compat.assert or assert; local ipairs = _tl_compat and _tl_compat.ipairs or ipairs; local math = _tl_compat and _tl_compat.math or math; local pairs = _tl_compat and _tl_compat.pairs or pairs; local string = _tl_compat and _tl_compat.string or string; local table = _tl_compat and _tl_compat.table or table; local type_checker = require("teal.checker.type_checker")
...
-- module teal.embed.prelude from teal/embed/prelude.lua
package.preload["teal.embed.prelude"] = function(...)
...
-- module teal.embed.stdlib from teal/embed/stdlib.lua
package.preload["teal.embed.stdlib"] = function(...)
...
T3.def={[K25]=K[3],[K38]={cur=true,["end"]=true,set=true,},f=K3,[K2]=977,[K1]="enum",x=4,y=146,}
T4.def={[K25]=K[4],[K38]={full=true,line=true,no=true,},f=K3,[K2]=979,[K1]="enum",x=4,y=150,}
T5.def={[K25]=K[8],[K38]={["*n"]=true,n=true,},f=K3,[K2]=555,[K1]="enum",x=1,y=18,}
...
T14.def={[K25]=K49,f=K3,[K[21]]={[K[20]]={[1]={[1]={text="-- TODO: what should compat be for these? (5.4+)",x=26,y=55,},},},},[K33]={[1]="name",[2]="namewhat",[3]="source",[4]="short_src",[5]="linedefined",[6]="lastlinedefined",[7]="what",[8]="currentline",[9]="istailcall",[10]="nups",[11]="nparams",[12]="isvararg",[13]="func",[14]="activelines",[15]="ftransfer",[16]=K[20],},[K32]={["activelines"]={f=K3,keys={f=K3,[K2]=626,[K1]=K12,x=21,y=54,},[K2]=627,[K1]="map",[K28]={f=K3,[K2]=628,[K1]=K24,x=29,y=54,},x=20,xend=36,y=54,yend=54,},["currentline"]={f=K3,[K2]=620,[K1]=K12,x=20,y=48,},["ftransfer"]={f=K3,[K2]=629,[K1]=K12,x=18,y=55,},func={f=K3,[K2]=625,[K1]="any",x=13,y=53,},["istailcall"]={f=K3,[K2]=621,[K1]=K24,x=19,y=49,},["isvararg"]={f=K3,[K2]=624,[K1]=K24,x=17,y=52,},["lastlinedefined"]={f=K3,[K2]=618,[K1]=K12,x=24,y=46,},["linedefined"]={f=K3,[K2]=617,[K1]=K12,x=20,y=45,},name={f=K3,[K2]=613,[K1]=K11,x=13,y=41,},["namewhat"]={f=K3,[K2]=614,[K1]=K11,x=17,y=42,},["nparams"]={f=K3,[K2]=623,[K1]=K12,x=16,y=51,},[K[20]]={f=K3,[K2]=630,[K1]=K12,x=18,y=56,},nups={f=K3,[K2]=622,[K1]=K12,x=13,y=50,},["short_src"]={f=K3,[K2]=616,[K1]=K11,x=18,y=44,},["source"]={f=K3,[K2]=615,[K1]=K11,x=15,y=43,},what={f=K3,[K2]=619,[K1]=K11,x=13,y=47,},},[K2]=612,[K1]=K37,x=4,y=40,}
...
T19.def={[K25]=K[23],f=K8,[K33]={},[K32]={},[K[10]]={},[K[2]]=true,["is_userdata"]=true,[K2]=9,[K1]=K[14],x=1,y=14,}
...
T21.def={[K25]=K[24],[K38]={b=true,bt=true,t=true,},f=K3,[K2]=1893,[K1]="enum",x=4,y=364,}
...
T26.def={f=K3,t={[K25]=K[36],[K30]=T27,f=K3,[K33]={[1]="n",},[K32]={n={f=K3,[K2]=1681,[K1]=K12,x=10,y=312,},},[K[10]]={[1]={[K30]=T27,f=K3,[K2]=1680,[K1]=K31,x=10,xend=12,y=310,yend=310,},},[K[2]]=true,[K2]=1678,[K1]=K37,x=4,y=309,},[K19]={[1]={f=K3,[K10]="A",[K2]=1677,[K1]=K10,x=21,y=309,},xend=22,yend=309,},[K2]=1682,[K1]=K20,x=4,y=309,}
